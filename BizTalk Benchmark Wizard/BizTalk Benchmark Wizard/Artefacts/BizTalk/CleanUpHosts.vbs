...
wscript.echo "**********************************************************"
'CleanUp BBW_RxHost
DeleteReceiveHandler "BBW_RxHost", "WCF-NetTcp", "MSBTS_ReceiveHandler"
DeleteReceiveHandler "BBW_RxHost", "WCF-NetTcp", "MSBTS_SendHandler2"
UnMapUninstallHostInstance "BBW_RxHost", WScript.Arguments(3)
DeleteHost "BBW_RxHost"
wscript.echo""
...
DeleteReceiveHandler "BBW_TxHost", "WCF-NetTcp", "MSBTS_SendHandler2"
UnMapUninstallHostInstance "BBW_TxHost", WScript.Arguments(4)
DeleteHost "BBW_TxHost"
wscript.echo""

wscript.echo "**********************************************************"
wscript.echo "CleanUp BBW_PxHost"
wscript.echo "**********************************************************"
UnMapUninstallHostInstance "BBW_PxHost", WScript.Arguments(5)
DeleteHost "BBW_PxHost"
